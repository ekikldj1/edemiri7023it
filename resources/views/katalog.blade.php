        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg p-6 flex space-x-8">
                ...
                <aside class="w-72 border border-gray-200 rounded p-6 bg-gray-50 flex-shrink-0">
                    ...
                    <ul class="space-y-3">
                        <li><a href="{{ route('katalog', 'Alkoholna pića') }}" class="text-blue-600 hover:underline">Alkoholna pića</a></li>
                        <li><a href="{{ route('katalog', 'Džemovi') }}" class="text-blue-600 hover:underline">Džemovi</a></li>
                        <li><a href="{{ route('katalog', 'Sokovi') }}" class="text-blue-600 hover:underline">Sokovi</a></li>
                    </ul>
                </aside>
