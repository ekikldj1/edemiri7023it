        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="/">
                        <span class="text-xl font-bold">Andrej Dostanic</span>
                    </a>
                    <a href="{{ url('/') }}">
                        <img src="{{ asset('storage/images/logo1.png') }}" alt="Logo" style="width: 25px; height: auto; margin-left: 20px; margin-right: 50px;">
                    </a>
                </div>
